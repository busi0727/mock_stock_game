...
------------------------
        ''')
                    ...
                    print(f'''
-----주식 목록-----
까까오의 주식 가격 : {stock_1}원    ㅣ {stock_1_up_}↑ {stock_1_down_}↓ {stock_1_up_ - stock_1_down_}원
삼선전자의 주식 가격 : {stock_2}원  ㅣ {stock_2_up_}↑ {stock_2_down_}↓ {stock_2_up_ - stock_2_down_}원
데슬라의 주식 가격 : {stock_3}원    ㅣ {stock_3_up_}↑ {stock_3_down_}↓ {stock_3_up_ - stock_3_down_}원
---------------
''')
                elif command[1] == '명령어':
...
------------------------
            ''')
                    ...
                    print(f'''
-----보유하고 있는 주식-----
까까오 : {stock_1_own}주 / 총 {stock_1*stock_1_own}원
삼선전자 : {stock_2_own}주 / 총 {stock_2*stock_2_own}원
데슬라 : {stock_3_own}주 / 총 {stock_3*stock_3_own}원
------------------------
                    ''')
                elif command[1] == '구매':
...
------------------------    
                    ''')
                            ...
                            if stock_1*purchase_num <= money:
                                print(f'''
------------------------
까까오 {purchase_num}주를 {stock_1*purchase_num}원에 구매하셨습니다.
------------------------
            ''')
                                ...
                                print(f'''
------------------------
돈이 {stock_1*purchase_num-money}원 부족합니다.
------------------------
            ''')
...
------------------------    
                    ''')
                            ...
                            if stock_2*purchase_num <= money:
                                print(f'''
------------------------
삼선전자 {purchase_num}주를 {stock_2*purchase_num}원에 구매하셨습니다.
------------------------
            ''')
                                ...
                                print(f'''
------------------------
돈이 {stock_2*purchase_num-money}원 부족합니다.
------------------------
            ''')
...
------------------------    
                    ''')
                            ...
                            if stock_3*purchase_num <= money:
                                print(f'''
------------------------
데슬라 {purchase_num}주를 {stock_3*purchase_num}원에 구매하셨습니다.
------------------------
            ''')
                                ...
                                print(f'''
------------------------
돈이 {stock_3*purchase_num-money}원 부족합니다.
------------------------
            ''')
                    else:
                        print('''
                    ...
                    if sell_stock == '까까오':
                        if stock_1_own >= 1:
                            ...
                            if stock_1_own >= sell_num:
                                print(f'''
------------------------
까까오 {sell_num}주를 {stock_1*sell_num}원에 판매하셨습니다.
------------------------
                                ''')
...
------------------------
                        ...
                        if stock_2_own >= 1:
                            ...
                            if stock_2_own >= sell_num:
                                print(f'''
------------------------
삼선전자 {sell_num}주를 {stock_2*sell_num}원에 판매하셨습니다.
------------------------
                                ''')
...
------------------------
                        ...
                        if stock_3_own >= 1:
                            ...
                            if stock_3_own >= sell_num:
                                print(f'''
------------------------
데슬라 {sell_num}주를 {stock_3*sell_num}원에 판매하셨습니다.
------------------------
                                ''')
